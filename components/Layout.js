        ...
        <nav className="bg-yellow-600 w-screen static">
          ...
          <div className="flex items-center pl-8 h-14 justify-end">
            ...
            <Link href="/cart">
              <a
                // data-testid="home-nav"
                className="relative hover:bg-yellow-700 duration-300 py-2 px-4 text-white rounded"
              >
                {cart.cartItems.length > 0 ? (
                  <div>
                    ...
                    <span className="absolute bg-red-600 px-2 py-1 text-xs font-bold rounded-full -top-3 -right-3"></span>
                  </div>
                ) : (
                  <svg
                    className="w-6 h-6 text-white"
